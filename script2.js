...
let ingr2 = document.getElementById('in')
// let acol 
nums()
...
function minus(coll) {
 ...
 function nums(){    
        ...
        ingr2.textContent = `Ингредиенты: молоко — ${num1} мл,  яйцо куриное — ${num2} шт., соль — ${num3} шепотка, сахар — ${num4} столовые ложки, мука — ${num5} стакана, растительное масло — ${num6} столовые ложки, сыр Пармезан крошка — на мончике ножа`
     }